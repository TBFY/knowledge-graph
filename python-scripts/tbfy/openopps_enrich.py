...
def enrich_tender(release_data):
    ...
    tbfy.json_utils.add_property_to_single_node(release_data, "releases.[0].tender.value", "tbfy_ocid", ocid)
    tbfy.json_utils.add_property_to_single_node(release_data, "releases.[0].tender.value", "tbfy_tender_id", tender_id)
