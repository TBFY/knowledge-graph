...
def print_stats():
    ...
    print("*********************************************************")
    print("Enrich JSON statistics - performance (aggregated)        ")
    print("*********************************************************")
...
def main(argv):
    ...
    try:
        ...
        print("enrich_json_statistics.py -s <start_date> -e <end_date> -i <enrich_json_folder>")
        sys.exit(2)
    for opt, arg in opts:
        if opt == "-h":
            print("enrich_json_statistics.py -s <start_date> -e <end_date> -i <enrich_json_folder>")
            ...
            enrich_json_folder = arg

    logging.info("main(): start_date = " + start_date)
    logging.info("main(): end_date = " + end_date)
    logging.info("main(): enrich_json_folder = " + enrich_json_folder)
    ...
    while start <= stop:
        ...
        stats_filepath = os.path.join(enrich_json_folder, dirname, 'STATISTICS.TXT')
